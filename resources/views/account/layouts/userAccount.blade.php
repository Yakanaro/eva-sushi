...
{{--user name--}}
        <div class="flex flex-row">
            ...
            <p class="text-center">{{$user->name ?? 'Имя не указано'}}</p>
        </div>
{{--phone user--}}
        <div class="flex flex-row">
            <svg height="50px" width="50px" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
...
{{--email user--}}
        <div class="flex flex-row">
            ...
            <p class="text-center">{{$user->email ?? 'Email не указан'}}</p>
        </div>
    </div>
{{--buttons(edit, logout--}}
