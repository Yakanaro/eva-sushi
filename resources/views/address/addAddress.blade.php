...
{{--                    <!-- Дом, Корпус, Подьезд, Квартира, Этаж, Код домофона(Необязательно) -->--}}
...
{{--                        <input type="text" name="building" id="building" placeholder="" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required>--}}
{{--                    </div>--}}

{{--                    <div class="flex flex-col">--}}
{{--                        <label for="" class="block mb-2 text-sm font-medium text-gray-900 text-center">Подъезд</label>--}}
{{--                        <input type="" name="entrance" id="entrance" placeholder="" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required>--}}
{{--                    </div>--}}
{{--                </div>--}}

{{--                <div class="flex space-x-2">--}}
{{--                    <div class="flex flex-col">--}}
{{--                        <label for="" class="block mb-2 text-sm font-medium text-gray-900 text-center">Квартира</label>--}}
{{--                        <input type="" name="apartment" id="apartment" placeholder="" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required>--}}
{{--                    </div>--}}

{{--                    <div class="flex flex-col">--}}
{{--                        <label for="" class="block mb-2 text-sm font-medium text-gray-900 text-center">Этаж</label>--}}
{{--                        <input type="" name="floor" id="floor" placeholder="" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required>--}}
{{--                    </div>--}}

{{--                    <div class="flex flex-col">--}}
{{--                        <label for="" class="block mb-2 text-sm font-medium text-gray-900 text-center">Код домофона</label>--}}
{{--                        <input type="" name="intercom_code" id="intercom_code" placeholder="" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required>--}}
{{--                    </div>--}}
{{--                </div>--}}

{{--                <button type="submit" class="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Сохранить</button>--}}
{{--            </form>--}}
{{--        </div>--}}
{{--    </div>--}}
{{--</div>--}}
