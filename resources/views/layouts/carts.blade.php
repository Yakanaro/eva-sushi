<div class="relative overflow-x-auto shadow-md sm:rounded-lg">
    ...
    <div class="flex flex-row">
        <select id="countries" class="h-11 mr-2 ml-2 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
    ...
    <div class="ml-2 mr-2">
        ...
        <textarea id="message" rows="1" class="block mr-3 p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500" placeholder="Ваш комментарий"></textarea>
    </div>
    <div class="flex flex justify-center items-center">
